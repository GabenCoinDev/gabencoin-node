...
var makeClient = function makeClient() {
  return new gabencoin.Client(config);
};
...
describe('Client', function() {
  ...
  it('gabencoin related error should be an Error object', function(done) {
    var client = makeClient();
  ...
  describe('invalid credentials', function() {
    ...
    var client = new gabencoin.Client(badCredentials);

    it('should still return client object', function(done) {
      assert.ok(client instanceof gabencoin.Client);
      done();
    });
  ...
  describe('creating client on non-listening port', function() {
    ...
    badPort.pass = 'badpwd';
    var client = new gabencoin.Client(badPort);
  ...
  describe('response headers', function() {
    var assertResHeaders = function(resHeaders) {
      ...
      assert.ok(/gabencoin/.test(resHeaders.server));
    };
